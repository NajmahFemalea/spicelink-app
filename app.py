...
def display_spices():
    ...
    descriptions = {
        ...
        'Kencur': 'Kencur (_Kaempferia galanga_) Selain memperkaya cita rasa hidangan, rimpang kencur juga diolah menjadi jamu tradisional seperti beras kencur karena khasiatnya. Kencur juga dapat meredakan batuk, flu, sakit kepala, keseleo, radang lambung, hingga memperlancar haid dan mengatasi radang telinga. (Hakim, 2015)',
